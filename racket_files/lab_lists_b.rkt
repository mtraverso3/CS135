...
(define (quad-roots a b c)
  (define (pos a b c) (/ (+ (* -1 b) (sqrt (- (* b b) (* (* 4 a) c)))) (* 2 a)))
  (define (neg a b c) (/ (- (* -1 b) (sqrt (- (* b b) (* (* 4 a) c)))) (* 2 a)))
  (list (neg a b c) (pos a b c))
  )
...
;; 2 PTS
(define (rotate c)
  (define (get90 a) (list (cadr a) (* -1 (car a)) ) )
  (list c (get90 c) (get90 (get90 c)) (get90 (get90 (get90 c))) )
   )
...
(define (combine-products b1 b2)
  (define (getProd b)(cadr(cddddr b)) )
  (append  (getProd b1) (getProd b2))
  )
